...
class ActualitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actualite" do
    assert_difference('Actualite.count') do
      post actualites_url, params: { actualite: { content: @actualite.content, date: @actualite.date, statut: @actualite.statut, title: @actualite.title } }
    end
  ...
  test "should update actualite" do
    patch actualite_url(@actualite), params: { actualite: { content: @actualite.content, date: @actualite.date, statut: @actualite.statut, title: @actualite.title } }
